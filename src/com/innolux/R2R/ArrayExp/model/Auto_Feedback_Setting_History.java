...
public class Auto_Feedback_Setting_History {
	@Column("Active_Flag")
	...
	public String toString() {
		return "Auto_Feedback_Setting_History [Active_Flag=" + Active_Flag + ", Eqp_ID=" + Eqp_ID + ", Exp_Step_Id="
				+ Exp_Step_Id + ", Mea_Step_Id=" + Mea_Step_Id + ", Exp_Rcp_Id=" + Exp_Rcp_Id + ", Exp_Rcp_Name="
				+ Exp_Rcp_Name + ", Mea_Rcp=" + Mea_Rcp + ", Feedback_Mode=" + Feedback_Mode + ", U_Upper_Limit="
				+ U_Upper_Limit + ", L_Upper_Limit=" + L_Upper_Limit + ", U_Lower_Limit=" + U_Lower_Limit
				+ ", L_Lower_Limit=" + L_Lower_Limit + ", Ratio=" + Ratio + ", Sigma=" + Sigma + ", Population_Size="
				+ Population_Size + ", Sample_Size=" + Sample_Size + ", Expire_time=" + Expire_time + ", Update_Time="
				+ Update_Time + ", Update_UserID=" + Update_UserID + "]";
	}
